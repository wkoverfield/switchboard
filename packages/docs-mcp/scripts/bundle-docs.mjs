...
const manifest = [
  ...
  { source: "docs/security/attenuation.md", path: "security/attenuation.md", title: "Spawn Attenuation", description: "Opt-in per-subagent child passes: single-level guarantee, nesting roadmap, limits." },
